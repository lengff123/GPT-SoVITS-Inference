...
try:
    from config import gpt_path as config_gpt_path, sovits_path as config_sovits_path
    gpt_path = os.environ.get("gpt_path", config_gpt_path)
    sovits_path = os.environ.get("sovits_path", config_sovits_path)
except ImportError:
